    ...
    <Layout>
      <div className="p-8 max-w-2xl" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <p className="text-xs text-[#8a8478] mb-6">
          No se devuelve dinero. Solo cambio por artículo de igual o mayor precio (se paga la diferencia). Menudeo: 6 días. Garantía: 3 meses únicamente por deschapeado.
        </p>
        ...
        {ventaEncontrada && (
          <div className="border border-[#2a251c] p-5 mb-6">
            ...
            <p className="text-xs text-[#8a8478] uppercase mb-2">Selecciona el producto a cambiar</p>
            <select
            ...
            <label className="flex items-center gap-2 text-sm text-[#f5f1e8] mb-4">
              ...
              La pieza original está defectuosa/dañada (no regresa al inventario, se da de baja)
            </label>
